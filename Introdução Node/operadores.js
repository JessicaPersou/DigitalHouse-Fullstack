...
console.log( "\nOPERADORES DE COMPARAÇÃO:  ") // pode ser usador para comparar qualquer tipo de valor, string, array, float e int ,
let valores1 = 5
let valores2 = 5
...
console.log( "\nOPERADORES CAST:  ") // ele força a conversão de dados seja qual for 
if( valor1 ===  v2){
...
console.log( "\nOPERADORES DE TERNÁRIO:  ") // pode ser usado com qualquer valor
